...
if (effect_timer > 0) {
    ...
    if (effect_timer == 0) {
        ...
        is_stunned = false;
        is_confused = false;
        confused_keys = [ord("W"), ord("S"), ord("A"), ord("D")]; // reset
...
if (is_confused && !confusion_shuffled) {
    ...
    show_debug_message("Keys shuffled! New mapping:");
    show_debug_message("W -> " + chr(confused_keys[0]));
    show_debug_message("S -> " + chr(confused_keys[1]));
    show_debug_message("A -> " + chr(confused_keys[2]));
    show_debug_message("D -> " + chr(confused_keys[3]));
}
