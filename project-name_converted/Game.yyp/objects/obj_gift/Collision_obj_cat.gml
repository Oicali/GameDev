...
switch(chosen) {
    case "mouse_fast":
        ...
        if (instance_exists(mouse_instance)) {
            mouse_instance.spd = mouse_instance.base_spd + 2;
    ...
    case "mouse_stun":
        indicator_sprite = spr_effect_stun;
        indicator_color = c_yellow;
    ...
    case "mouse_confused":
        indicator_sprite = spr_effect_confuse;
        indicator_offset_x = 5; // Move right by 5 pixels
